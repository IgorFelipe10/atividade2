const hobbies = [
    ...
    {
        nome: "Assistir jogo do Palmeiras"
    },
    {
...
const exibirHobbies4 = () => {
   const posicao = hobbies.findIndex(function(hobby) {
        return hobby.nome === 'Jogar futebol';
    });
    console.log("Jogar futebol está na posição " + posicao);
}
...
const exibirHobbies8 = () => {
    const seteLetrasHobby = hobbies.find(function(hobby) {
        ...
        console.log("Meu primeiro hobby com 7 letras é: " + seteLetrasHobby.nome);
}
